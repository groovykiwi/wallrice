...
export const MacOSMenuBar: React.FC<MacOSMenuBarProps> = ({ uiHidden }) => (
  <div
    className={`absolute top-0 left-0 right-0 h-6 flex items-center justify-between px-4 z-10 ${
    ...
    <div className="relative z-30 flex w-full items-center justify-between">
      <div className="flex items-center space-x-6 select-none">
        <span className="text-white text-sm font-bold flex items-center">
          <svg className="w-3 h-3 mr-0" viewBox="0 0 24 24" fill="currentColor">
